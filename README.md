...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **US001** | Crear nueva vacante | W-01 | Implementar lógica de guardado de vacante (Backend) | Crear endpoint para registrar nueva vacante vinculada al ID del reclutador creador. | 5 | Ysaac Villanueva | Done |
| **US001** | Crear nueva vacante | W-02 | Diseñar formulario de creación de vacante (Frontend) | Interfaz con campos de título, descripción, requerimientos, salario y etiquetas de habilidades. | 6 | María Hernández | Done |
| **US002** | Editar vacante existente | W-03 | Crear endpoint de actualización PUT | Lógica backend para modificar los datos de una vacante ya publicada. | 3 | Fabricio Vega | Done |
| **US003** | Eliminar/Cerrar vacante | W-04 | Implementar cambio de estado de vacante | Endpoint PATCH para cambiar el estado de la vacante a "Cerrada" e inhabilitar postulaciones. | 2 | Ysaac Villanueva | Done |
| **US004** | Aplicar a vacante | W-05 | Endpoint para recibir postulaciones y subir CV | Configurar servicio de almacenamiento de PDF y crear registro en tabla pivote de postulaciones. | 8 | Fabricio Vega | Done |
| **US004** | Aplicar a vacante | W-06 | Implementar botón y modal de postulación | Flujo UI donde el usuario confirma su aplicación y sube su archivo CV en formato PDF. | 4 | Jasmin Urrutia | Done |
| **US006** | Visualizar resumen en Dashboard | W-08 | Diseñar panel de control | Interfaz para que el reclutador vea y organice el resumen de su actividad en el panel principal. | 6 | María Hernández | Done |
| **US007** | Registrar cuenta de postulante | W-13 | Implementar endpoint de registro para postulantes | Ruta POST para validar datos, encriptar contraseña y guardar en base de datos. | 5 | Ysaac Villanueva | Done |
| **US007** | Registrar cuenta de postulante | W-14 | Crear interfaz UI de registro de postulante | Maquetar formulario de registro con validaciones frontend (email, contraseñas coincidentes). | 4 | María Hernández | Done |
| **US008** | Registrar cuenta de reclutador | W-15 | Implementar endpoint de registro para empresas | Ruta POST que incluye datos de la empresa (RUC) y asigna roles de reclutador. | 5 | Fabricio Vega | Done |
| **US009** | Editar perfil profesional | W-16 | UI de edición de perfil y portafolio | Vistas para que el postulante agregue su experiencia laboral, educación y habilidades. | 6 | Jasmin Urrutia | Done |
| **US012** | Puntaje automático de CVs | W-19 | Integrar API de Parsing de CVs | Conectar servicio para extraer texto de PDFs y generar un porcentaje de compatibilidad (Match %). | 8 | Ysaac Villanueva | Done |
| **US012** | Puntaje automático de CVs | W-20 | Componente visual de Match Score | Barras circulares e indicadores de colores en la UI para mostrar la afinidad del candidato. | 5 | María Hernández | Done |
| **US013** | Notificaciones de vacantes | W-21 | Sistema de notificaciones Push/Email (Postulantes) | Configurar servicio (ej. Firebase/SendGrid) para alertar sobre nuevos empleos. | 6 | Fabricio Vega | Done |
| **US014** | Notificaciones de postulación | W-22 | Alertas en tiempo real (Reclutadores) | Implementar WebSockets para notificar al reclutador cuando alguien aplica a su vacante. | 6 | Ysaac Villanueva | Done |
| **US015** | Seleccionar rol de usuario | W-34 | Gestión de Roles (RBAC) Interno | Endpoint administrativo para elevar privilegios de un usuario a cuenta corporativa o reclutador. | 3 | Ysaac Villanueva | Done |
